              ...
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <dd className="mt-2 ml-16 text-base text-gray-500">
                    Explore our extensive catalog featuring the latest and most
                    popular software products. From industry-leading brands to
                    innovative new releases, you'll find everything you need to
